...
export default function BottomPane({
  ...
  const CustomDrawer = styled(SwipeableDrawer)(({ theme }) => ({
    ".MuiDrawer-paper": {
      maxHeight: "70%", // Set the height you want
      overflowY: "auto", // Enable vertical scrolling if content overflows
      boxShadow: `-2px 0 10px rgba(0,0,0,0.3)`, // Optional shadow effect
  ...
  return (
    <div style={{ maxHeight: "80%" }}>
      ...
      {/* <AppButton
        style={{ width: "100%", paddingTop: 10, paddingBottom: 10, marginBottom: 20 }}
        title={"Add Data"}></AppButton> */}
      <Button
        style={{ width: 100, height: 50, backgroundColor: "rgb(245, 246, 247)" }}
      ...
      <CustomDrawer
        ...
        <Tabs style={{ height: "80%" }} className={""}>
          ...
          <div style={{ backgroundColor: "rgb(245, 246, 247)", padding: 10 }}>
            <AppButton
